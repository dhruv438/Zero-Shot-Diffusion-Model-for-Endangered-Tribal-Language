...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$PSScriptRoot'; backend\.venv\Scripts\python.exe -m uvicorn backend.app.main:get_app --host 127.0.0.1 --port 5002"
