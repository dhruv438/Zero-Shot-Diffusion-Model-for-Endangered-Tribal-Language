      ...
      <div className="landing-shell">
        <header className="landing-nav">
          ...
          <div className="nav-actions">
            <button className="ghost-btn" onClick={() => window.open('https://github.com/dhruv438/Zero-Shot-Diffusion-Model-for-Endangered-Tribal-Language', '_blank')}>
              View Research
            </button>
        ...
        <main className="hero-stack">
          <div className="hero-copy">
            <p className="eyebrow desia-body">Preserving Tribal Heritage Through AI</p>
            <h1 className="hero-title desia-display">
        ...
        <section className="problem-section">
          <div className="section-header">
            <h2 className="desia-display">Challenges of Endangered Languages</h2>
        ...
        <section className="solution-section" id="solution-section">
          <div className="section-header">
            <h2 className="desia-display">Our Zero-Shot Diffusion Approach</h2>
            <p className="section-subtitle">
        ...
        <section className="features-section">
          <div className="section-header">
            <h2 className="desia-display">Powerful Features for Language Preservation</h2>
            <p className="section-subtitle">
        ...
        <section className="cta-section">
          <div className="cta-card">
            <h2 className="desia-display">Ready to Experience Zero-Shot Translation?</h2>
